...
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= $\v, C =< $( ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= $+, C =< $ÿ ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(37, Ics, Line, Tlen, Action, Alen) ->
...
yystate(36, [C|Ics], Line, Tlen, Action, Alen) when C >= $\v, C =< $! ->
    yystate(38, Ics, Line, Tlen+1, Action, Alen);
yystate(36, [C|Ics], Line, Tlen, Action, Alen) when C >= $#, C =< $& ->
    yystate(38, Ics, Line, Tlen+1, Action, Alen);
...
yystate(33, Ics, Line, Tlen, Action, Alen) ->
    {5,Tlen,Ics,Line,33};
yystate(32, [$\n|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line+1, Tlen+1, 18, Tlen);
...
yystate(32, [C|Ics], Line, Tlen, Action, Alen) when C >= $\v, C =< $! ->
    yystate(12, Ics, Line, Tlen+1, 18, Tlen);
yystate(32, [C|Ics], Line, Tlen, Action, Alen) when C >= $#, C =< $[ ->
    yystate(12, Ics, Line, Tlen+1, 18, Tlen);
...
yystate(27, [$*|Ics], Line, Tlen, Action, Alen) ->
    yystate(35, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= $\000, C =< $\t ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= $\v, C =< $) ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(27, [C|Ics], Line, Tlen, Action, Alen) when C >= $+, C =< $ÿ ->
    yystate(27, Ics, Line, Tlen+1, Action, Alen);
yystate(27, Ics, Line, Tlen, Action, Alen) ->
...
yystate(24, [C|Ics], Line, Tlen, Action, Alen) when C >= $#, C =< $[ ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(24, [C|Ics], Line, Tlen, Action, Alen) when C >= $_, C =< $ÿ ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(24, Ics, Line, Tlen, Action, Alen) ->
...
yystate(22, [$_|Ics], Line, Tlen, Action, Alen) ->
    yystate(22, Ics, Line, Tlen+1, 0, Tlen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= $0, C =< $9 ->
    yystate(22, Ics, Line, Tlen+1, 0, Tlen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= $A, C =< $Z ->
    yystate(22, Ics, Line, Tlen+1, 0, Tlen);
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= $a, C =< $z ->
    yystate(22, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= $\v, C =< $! ->
    yystate(12, Ics, Line, Tlen+1, 3, Tlen);
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= $#, C =< $[ ->
    yystate(12, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= $\000, C =< $\t ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= $\v, C =< $! ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= $#, C =< $[ ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= $], C =< $ÿ ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(16, Ics, Line, Tlen, Action, Alen) ->
...
yystate(13, [$\n|Ics], Line, Tlen, Action, Alen) ->
    yystate(9, Ics, Line+1, Tlen+1, 18, Tlen);
...
yystate(9, Ics, Line, Tlen, Action, Alen) ->
    {19,Tlen,Ics,Line};
yystate(8, [$\n|Ics], Line, Tlen, Action, Alen) ->
    yystate(11, Ics, Line+1, Tlen+1, 18, Tlen);
...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= $\v, C =< $& ->
    yystate(11, Ics, Line, Tlen+1, 4, Tlen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= $(, C =< $[ ->
    yystate(11, Ics, Line, Tlen+1, 4, Tlen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= $], C =< $ÿ ->
    yystate(11, Ics, Line, Tlen+1, 4, Tlen);
yystate(3, Ics, Line, Tlen, Action, Alen) ->
    {4,Tlen,Ics,Line,3};
...
yyaction(5, YYlen, YYtcs, YYline) -> skip_token;
